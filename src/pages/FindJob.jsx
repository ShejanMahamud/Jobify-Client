  ...
  return (
    <div className="font-inter w-full">
      <div className="bg-[#F1F2F4] py-10 flex flex-col items-center gap-5 w-full px-20">
        ...
        <div className="bg-white px-5 py-3 rounded-lg flex justify-between items-center gap-10 w-full">
...
<input type="text" className="w-full bg-transparent focus:outline-none" placeholder="Job Title"/>
            </div>
...
<input type="text" className="w-full bg-transparent focus:outline-none" placeholder="Job Location"/>
            </div>
            <div className="w-[2px] h-[20px] bg-[#E4E5E8] rounded-full"></div>
            <div className="flex items-center gap-3 w-full">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<select name="" className="w-full focus:outline-none">
    <option value="type" selected disabled>Job Type</option>
...
<input type="text" className="w-full bg-transparent focus:outline-none" placeholder="Advanced Filter"/>
            ...
            <button className="bg-primary text-white font-medium px-4 py-3 rounded-lg w-full">
                Find Job
            </button>
        </div>
      </div>
  ...
  <path d="M16 11H12C11.4477 11 11 11.4477 11 12V16C11 16.5523 11.4477 17 12 17H16C16.5523 17 17 16.5523 17 16V12C17 11.4477 16.5523 11 16 11Z" fill="#18191C"/>
