  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center justify-start gap-40'>
        ...
        <div className='flex flex-col items-center gap-5'>
            ...
            <p className='text-[#767F8C] w-1/2'>We've sent an verification to <span className='text-[#18191C]'>emailaddress@gmail.com</span> to verify your email address and activate your account.</p>
