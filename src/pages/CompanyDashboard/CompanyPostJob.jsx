...
const CompanyPostJob = () => {
  ...
  return (
    <div className="w-full min-h-screen px-5 py-5 font-inter border-l border-[#E4E5E8]">
      ...
      <button className="bg-primary px-4 py-3 rounded-md text-white font-medium flex items-center gap-3 w-[50%]">
<span>Apply Now</span>
